...
#   lcls2/psana/psana/pscalib/geometry/SegGeometryJungfrauV2.py
...
Usage::
    ...
    from .SegGeometryJungfrauV2 import jungfrau_front as sg
    # OR
...
from .SegGeometryJungfrauV1 import * # SegGeometryJungfrauV1, logging, np
